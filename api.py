...
def get_agent(system_instructions: Optional[str] = None) -> CustomPromptAgent:
    ...
    default_instructions = (
        ...
        "4a. Error correct only if error correction is needed. If you know a field is incorrect but cannot with confidence correct the error, give a best guess."
        "4b. Error correct with thought that the result is coming from an OCR engine, so mistakes that are *optically similar* are more likely."
